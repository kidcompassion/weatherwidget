...
var conditionArray = new Array();
	//applies appropriate class to i based on weather condition code. list of codes at https://developer.yahoo.com/weather/#codes
	...
	$(function() {
	  $.simpleWeather({
	    ...
	    success: function(weather) {
	      ...
	      html += '<footer>Made with love by <a href="http://sallypoulsen.com" target="_blank">Sally</a>, using <a href="https://developer.yahoo.com/weather/" target="_blank">Yahoo Weather</a>, <a href="http://simpleweatherjs.com/" target="_blank">SimpleWeather.js</a> and <a href="http://erikflowers.github.io/weather-icons/" target="_blank">Weather Icons</a></footer>';
